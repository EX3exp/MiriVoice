...
if sys.platform == 'win32':
    ...
    os.system(
        "dotnet publish Mirivoice.Desktop/Mirivoice.Desktop.csproj -c Release -r win-x86 --self-contained true -o bin/win-x86")
    ...
    os.system(
        "dotnet publish Mirivoice.Desktop/Mirivoice.Desktop.csproj -c Release -r win-x64 --self-contained true -o bin/win-x64")
    ...
    os.system(
        "dotnet publish Mirivoice.Desktop/Mirivoice.Desktop.csproj -c Release -r linux-x64 --self-contained true -o bin/linux-x64")
